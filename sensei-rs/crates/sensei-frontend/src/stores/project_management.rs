...
impl ProjectManagementStore {
    ...
    fn start_op(&self, op: &str) {
        self.loading_ops.update(|ops| { ops.insert(op.to_string()); });
        self.error.set(None);
    }

    fn end_op(&self, op: &str) {
        self.loading_ops.update(|ops| { ops.remove(op); });
    }
    ...
    pub async fn create_project(&self, client: &ApiClient, payload: serde_json::Value) -> Result<Project, ()> {
        self.start_op("createProject");
        match client.post::<Project, serde_json::Value>("/projects", &payload).await {
            Ok(project) => {
    ...
    pub async fn update_project(&self, client: &ApiClient, id: &str, updates: serde_json::Value) -> Result<Project, ()> {
        self.start_op("updateProject");
        match client.put::<Project, serde_json::Value>(&format!("/projects/{id}"), &updates).await {
            Ok(updated) => {
    ...
    pub async fn fetch_epics(&self, client: &ApiClient, project_id: &str) {
        ...
        match client.get::<Vec<Epic>>(&format!("/projects/{project_id}/epics")).await {
    ...
    pub async fn create_epic(&self, client: &ApiClient, project_id: &str, subject: &str, description: &str) -> Result<Epic, ()> {
        self.start_op("createEpic");
        let payload = serde_json::json!({ "subject": subject, "description": description });
        match client.post::<Epic, serde_json::Value>(&format!("/projects/{project_id}/epics"), &payload).await {
            Ok(epic) => {
    ...
    pub async fn fetch_sprints(&self, client: &ApiClient, project_id: &str) {
        ...
        match client.get::<Vec<Sprint>>(&format!("/projects/{project_id}/sprints")).await {
    ...
    pub async fn create_sprint(&self, client: &ApiClient, project_id: &str, name: &str, start_date: &str, end_date: &str) -> Result<Sprint, ()> {
        ...
        match client.post::<Sprint, serde_json::Value>(&format!("/projects/{project_id}/sprints"), &payload).await {
            Ok(sprint) => {
    ...
    pub async fn fetch_stories(&self, client: &ApiClient, project_id: &str) {
        ...
        match client.get::<Vec<UserStory>>(&format!("/projects/{project_id}/stories")).await {
    ...
    pub async fn create_story(&self, client: &ApiClient, payload: serde_json::Value) -> Result<UserStory, ()> {
        self.start_op("createStory");
        match client.post::<UserStory, serde_json::Value>("/stories", &payload).await {
            Ok(story) => {
    ...
    pub async fn update_story(&self, client: &ApiClient, story_id: &str, updates: serde_json::Value) -> Result<UserStory, ()> {
        self.start_op("updateStory");
        match client.put::<UserStory, serde_json::Value>(&format!("/stories/{story_id}"), &updates).await {
            Ok(updated) => {
    ...
    pub async fn update_story_status(&self, client: &ApiClient, story_id: &str, status: &str) -> Result<UserStory, ()> {
        self.update_story(client, story_id, serde_json::json!({ "status": status })).await
    }
    ...
    pub async fn fetch_issues(&self, client: &ApiClient, project_id: &str) {
        ...
        match client.get::<Vec<Issue>>(&format!("/projects/{project_id}/issues")).await {
    ...
    pub async fn create_issue(&self, client: &ApiClient, payload: serde_json::Value) -> Result<Issue, ()> {
        self.start_op("createIssue");
        match client.post::<Issue, serde_json::Value>("/issues", &payload).await {
            Ok(issue) => {
    ...
    pub async fn update_issue(&self, client: &ApiClient, issue_id: &str, updates: serde_json::Value) -> Result<Issue, ()> {
        self.start_op("updateIssue");
        match client.put::<Issue, serde_json::Value>(&format!("/issues/{issue_id}"), &updates).await {
            Ok(updated) => {
    ...
    pub async fn fetch_issue_comments(&self, client: &ApiClient, issue_id: &str) {
        ...
        match client.get::<Vec<IssueComment>>(&format!("/issues/{issue_id}/comments")).await {
    ...
    pub async fn create_issue_comment(&self, client: &ApiClient, issue_id: &str, content: &str) -> Result<IssueComment, ()> {
        self.start_op("createIssueComment");
        let payload = serde_json::json!({ "content": content });
        match client.post::<IssueComment, serde_json::Value>(&format!("/issues/{issue_id}/comments"), &payload).await {
            Ok(comment) => {
    ...
    pub async fn fetch_wiki_pages(&self, client: &ApiClient, project_id: &str) {
        ...
        match client.get::<Vec<WikiPage>>(&format!("/projects/{project_id}/wiki")).await {
    ...
    pub async fn create_wiki_page(&self, client: &ApiClient, payload: serde_json::Value) -> Result<WikiPage, ()> {
        self.start_op("createWikiPage");
        match client.post::<WikiPage, serde_json::Value>("/wiki", &payload).await {
            Ok(page) => {
    ...
    pub async fn update_wiki_page(&self, client: &ApiClient, page_id: &str, updates: serde_json::Value) -> Result<WikiPage, ()> {
        self.start_op("updateWikiPage");
        match client.put::<WikiPage, serde_json::Value>(&format!("/wiki/{page_id}"), &updates).await {
            Ok(updated) => {
    ...
    pub async fn fetch_milestones(&self, client: &ApiClient, project_id: &str) {
        ...
        match client.get::<Vec<ProjectMilestone>>(&format!("/projects/{project_id}/milestones")).await {
    ...
    pub async fn create_milestone(&self, client: &ApiClient, payload: serde_json::Value) -> Result<ProjectMilestone, ()> {
        self.start_op("createMilestone");
        match client.post::<ProjectMilestone, serde_json::Value>("/milestones", &payload).await {
            Ok(milestone) => {
    ...
    pub async fn update_milestone(&self, client: &ApiClient, milestone_id: &str, updates: serde_json::Value) -> Result<ProjectMilestone, ()> {
        self.start_op("updateMilestone");
        match client.put::<ProjectMilestone, serde_json::Value>(&format!("/milestones/{milestone_id}"), &updates).await {
            Ok(updated) => {
    ...
    pub async fn delete_milestone(&self, client: &ApiClient, milestone_id: &str) -> Result<(), ()> {
        self.start_op("deleteMilestone");
        match client.delete::<serde_json::Value>(&format!("/milestones/{milestone_id}")).await {
            Ok(_) => {
                self.milestones.update(|m| m.retain(|x| x.id != milestone_id));
    ...
    pub async fn fetch_activities(&self, client: &ApiClient, project_id: &str) {
        ...
        match client.get::<Vec<ProjectActivity>>(&format!("/projects/{project_id}/activities")).await {
    ...
    pub async fn fetch_subtasks(&self, client: &ApiClient, story_id: &str) {
        ...
        match client.get::<Vec<Subtask>>(&format!("/stories/{story_id}/subtasks")).await {
    ...
    pub async fn create_subtask(&self, client: &ApiClient, story_id: &str, subject: &str, description: &str, status: &str) -> Result<Subtask, ()> {
        ...
        match client.post::<Subtask, serde_json::Value>(&format!("/stories/{story_id}/subtasks"), &payload).await {
            Ok(subtask) => {
    ...
    pub async fn update_subtask(&self, client: &ApiClient, subtask_id: &str, updates: serde_json::Value) -> Result<Subtask, ()> {
        self.start_op("updateSubtask");
        match client.put::<Subtask, serde_json::Value>(&format!("/subtasks/{subtask_id}"), &updates).await {
            Ok(updated) => {
    ...
    pub async fn fetch_story_comments(&self, client: &ApiClient, story_id: &str) {
        ...
        match client.get::<Vec<StoryComment>>(&format!("/stories/{story_id}/comments")).await {
    ...
    pub async fn create_story_comment(&self, client: &ApiClient, story_id: &str, content: &str) -> Result<StoryComment, ()> {
        self.start_op("createStoryComment");
        let payload = serde_json::json!({ "content": content });
        match client.post::<StoryComment, serde_json::Value>(&format!("/stories/{story_id}/comments"), &payload).await {
            Ok(comment) => {
