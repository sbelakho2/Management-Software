...
class CostAccountingService:
    ...
    def __init__(self, *, config: CostAccountingConfig | None = None, ledger: Any | None = None):
    ...
    def ship(
        ...
        *,
        ...
        sc = self.get_standard_cost(actor_roles=roles, sku=s, as_of=(shipped_at or _now()).date())
        if sc is None:
