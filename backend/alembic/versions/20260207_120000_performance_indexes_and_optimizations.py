...
def _safe_execute(sql: str) -> None:
    """Execute SQL inside a savepoint, silently rolling back on error."""
    conn = op.get_bind()
    try:
        conn.execute(sa.text("SAVEPOINT _safe_exec"))
        conn.execute(sa.text(sql))
        conn.execute(sa.text("RELEASE SAVEPOINT _safe_exec"))
    except Exception:
        conn.execute(sa.text("ROLLBACK TO SAVEPOINT _safe_exec"))
...
def upgrade() -> None:
    ...
    _safe_execute("""
        CREATE INDEX IF NOT EXISTS ix_tasks_status_due_date
    ...
    _safe_execute("""
        CREATE INDEX IF NOT EXISTS ix_tasks_created_by_status
    ...
    _safe_execute("""
        CREATE INDEX IF NOT EXISTS ix_work_orders_dispatch
    ...
    _safe_execute("""
        CREATE INDEX IF NOT EXISTS ix_work_orders_work_center_status
    ...
    _safe_execute("""
        CREATE INDEX IF NOT EXISTS ix_opportunities_account_stage
    ...
    _safe_execute("""
        CREATE INDEX IF NOT EXISTS ix_opportunities_close_date_stage
    ...
    _safe_execute("""
        CREATE INDEX IF NOT EXISTS ix_non_conformances_status_severity
    ...
    _safe_execute("""
        CREATE INDEX IF NOT EXISTS ix_non_conformances_product
    ...
    _safe_execute("""
        CREATE INDEX IF NOT EXISTS ix_capas_status_priority
    ...
    _safe_execute("""
        CREATE INDEX IF NOT EXISTS ix_capas_due_date
        ON capas (due_date)
    ...
    _safe_execute("""
        CREATE INDEX IF NOT EXISTS ix_notifications_expires
    ...
    _safe_execute("""
        CREATE INDEX IF NOT EXISTS ix_kanban_cards_board_column
    ...
    _safe_execute("""
        CREATE INDEX IF NOT EXISTS ix_andon_events_active
    ...
    _safe_execute("""
        CREATE INDEX IF NOT EXISTS ix_andon_events_work_center
    ...
    _safe_execute("""
        CREATE INDEX IF NOT EXISTS ix_issues_sprint_status
    ...
    _safe_execute("""
        CREATE INDEX IF NOT EXISTS ix_issues_project_priority
    ...
    _safe_execute("""
        CREATE INDEX IF NOT EXISTS ix_inspection_records_result_date
    ...
    _safe_execute("""
        CREATE INDEX IF NOT EXISTS ix_quotes_account_status
    ...
    _safe_execute("""
        CREATE INDEX IF NOT EXISTS ix_rfqs_status_due
    ...
    _safe_execute("""
        CREATE INDEX IF NOT EXISTS ix_learning_progress_user_completed
    ...
    _safe_execute("""
        CREATE INDEX IF NOT EXISTS ix_user_skills_skill_level
    ...
    # Active accounts
    _safe_execute("""
        CREATE INDEX IF NOT EXISTS ix_accounts_active
        ON accounts (name)
        WHERE deleted_at IS NULL
    """)
    ...
    _safe_execute("""
        CREATE INDEX IF NOT EXISTS ix_accounts_name_lower
    ...
    _safe_execute("""
        CREATE INDEX IF NOT EXISTS ix_autosave_drafts_expires
    ...
    _safe_execute("""
        CREATE INDEX IF NOT EXISTS ix_autosave_drafts_user
    ...
    _safe_execute("ANALYZE tasks")
    _safe_execute("ANALYZE work_orders")
    _safe_execute("ANALYZE opportunities")
    _safe_execute("ANALYZE non_conformances")
    _safe_execute("ANALYZE capas")
    _safe_execute("ANALYZE notifications")
    _safe_execute("ANALYZE kanban_cards")
    _safe_execute("ANALYZE andon_events")
    _safe_execute("ANALYZE users")
    _safe_execute("ANALYZE accounts")
    _safe_execute("ANALYZE quotes")
    _safe_execute("ANALYZE rfqs")
...
def downgrade() -> None:
    ...
    for idx in indexes:
        _safe_execute(f"DROP INDEX IF EXISTS {idx}")
