...
def upgrade() -> None:
    ...
    if not _table_exists("ap_invoices"):
        op.create_table(
            "ap_invoices",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("ap_payments"):
        op.create_table(
            "ap_payments",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("purchase_requisitions"):
        op.create_table(
    ...
    if not _table_exists("ar_invoices"):
        op.create_table(
            "ar_invoices",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("ar_payments"):
        op.create_table(
            "ar_payments",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("credit_memos"):
        op.create_table(
            "credit_memos",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("cost_centers"):
        op.create_table(
            "cost_centers",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("cost_allocations"):
        op.create_table(
            "cost_allocations",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    # #5 — fixed_assets.py
    if not _table_exists("fixed_assets"):
        op.create_table(
            "fixed_assets",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("depreciation_schedules"):
        op.create_table(
    ...
    if not _table_exists("labor_rates"):
        op.create_table(
            "labor_rates",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("payroll_batches"):
        op.create_table(
            "payroll_batches",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    # #7 — tax_service.py
    if not _table_exists("tax_rates"):
        op.create_table(
            "tax_rates",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    # #8 — cost_rollup.py
    if not _table_exists("cost_rollups"):
        op.create_table(
            "cost_rollups",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("compensation_records"):
        op.create_table(
    ...
    if not _table_exists("pay_bands"):
        op.create_table(
            "pay_bands",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("leave_accrual_rules"):
        op.create_table(
            "leave_accrual_rules",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("employee_lifecycle_events"):
        op.create_table(
    ...
    if not _table_exists("shift_schedules"):
        op.create_table(
            "shift_schedules",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("roster_assignments"):
        op.create_table(
            "roster_assignments",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("performance_goals"):
        op.create_table(
            "performance_goals",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("mrp_demand"):
        op.create_table(
            "mrp_demand",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("mrp_supply"):
        op.create_table(
            "mrp_supply",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("wms_locations"):
        op.create_table(
            "wms_locations",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("wms_inventory"):
        op.create_table(
            "wms_inventory",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("wms_pick_tasks"):
        op.create_table(
            "wms_pick_tasks",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("wms_shipments"):
        op.create_table(
            "wms_shipments",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("lot_records"):
        op.create_table(
            "lot_records",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("genealogy_records"):
        op.create_table(
            "genealogy_records",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("spc_measurements"):
        op.create_table(
            "spc_measurements",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("copq_records"):
        op.create_table(
            "copq_records",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("dispatch_travelers"):
        op.create_table(
            "dispatch_travelers",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("label_templates"):
        op.create_table(
            "label_templates",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("production_schedules"):
        op.create_table(
    ...
    if not _table_exists("tpm_assets"):
        op.create_table(
            "tpm_assets",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("pm_schedules"):
        op.create_table(
            "pm_schedules",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("tpm_work_orders"):
        op.create_table(
            "tpm_work_orders",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("downtime_events"):
        op.create_table(
            "downtime_events",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("spare_parts_inventory"):
        op.create_table(
    ...
    if not _table_exists("quality_documents"):
        op.create_table(
            "quality_documents",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("internal_audits"):
        op.create_table(
            "internal_audits",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("gauge_calibrations"):
        op.create_table(
            "gauge_calibrations",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("supplier_corrective_actions"):
        op.create_table(
    ...
    if not _table_exists("engineering_change_orders"):
        op.create_table(
    ...
    if not _table_exists("search_documents"):
        op.create_table(
            "search_documents",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("ai_patterns"):
        op.create_table(
            "ai_patterns",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("rag_feedback"):
        op.create_table(
            "rag_feedback",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("anomaly_alerts"):
        op.create_table(
            "anomaly_alerts",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("ai_training_jobs"):
        op.create_table(
            "ai_training_jobs",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("backup_schedules"):
        op.create_table(
            "backup_schedules",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("email_drafts"):
        op.create_table(
            "email_drafts",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("task_timing_sessions"):
        op.create_table(
    ...
    if not _table_exists("supplier_tokens"):
        op.create_table(
            "supplier_tokens",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
    ...
    if not _table_exists("service_state"):
        op.create_table(
            "service_state",
            sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
